...
import SheduleOrder from './pages/Dashboard/ScheduleOrder';
import Orders from './pages/Dashboard/Orders';
import ViewOrder from './pages/Dashboard/ViewOrder';
import HistoryOrder from './pages/Distributor/HistoryOrder';
...
// Protected route for distributors
const DistributorProtectedRoute = ({ children }) => {
  const distributorToken = localStorage.getItem("distributorToken");
  return distributorToken ? children : <Navigate to="/distributorLogin" replace />;
};

// Public route for distributors
const DistributorPublicRoute = ({ children }) => {
  const distributorToken = localStorage.getItem("distributorToken");
  return distributorToken ? <Navigate to="/distributorDashboard" replace /> : children;
};
function App() {
  return (
    <AuthProvider>
      <Router>
        <div className="App">
          ...
          <Routes>
            ...
            <Route path="/distributorLogin" element={<PublicRoute><DistributorLogin /></PublicRoute>} />
            <Route path="/distributorRegister" element={<PublicRoute><DistributorRegister /></PublicRoute>} />
            <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
              ...
              <Route path="sheduleOrder" element={<SheduleOrder />} />
              <Route path="orders" element={<Orders />} />
            </Route>
            <Route path="/distributorDashboard" element={<DistributorProtectedRoute><DistributorDashboard /></DistributorProtectedRoute>} />
